 ...
 */
public abstract class AbstractClientSkyjo extends Observable implements Runnable {
     ...
     */
    public AbstractClientSkyjo(String host, int port) {
        this.host = host;
        this.port = port;
    }

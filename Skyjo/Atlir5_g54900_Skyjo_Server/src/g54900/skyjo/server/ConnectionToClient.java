...
public class ConnectionToClient extends Thread {
    ...
    /**
     * index of the game associated to a client
     */
    ...
    /**
     * Gets the index of the game associated to the client.
     *
     * @return the index of the game associated to the client
     */
    ...
    /**
     * Gets the index of the connection/client.
     *
     * @return the index of the connection/client.
     */
    ...
    /**
     * Sets the indexGame of the client.
     *
     * @param indexGame the index of the game wich we have to associate to the
     * client.
     */
    ...
    /**
     * Sets the indexClient of the client.
     *
     * @param indexClient the new index to associate
     */
